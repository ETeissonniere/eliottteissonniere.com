  ...
  <Layout>
    ...
    <div className={styles.presentationContainer}>
      ...
      <Paragraph>
        ...
        be the CTO of{' '}
        <Link legacyBehavior href="https://bitnation.co">
          <a>BitNation</a>
        </Link>
        , a governance and crypto company which was rewarded by the{' '}
        <Link legacyBehavior href="https://en.unesco.org/news/netexplo-forum-celebrated-its-10th-edition">
          <a>NetExplo prize from UNESCO in 2017</a>
        </Link>
        , made the world’s first marriage dApp on Ethereum and leads{' '}
        <Link legacyBehavior href="https://nodle.io">
          <a>Nodle's</a>
        </Link>{' '}
        Blockchain and Engineering teams for which he co-invented multiple{' '}
        <Link legacyBehavior href="https://patents.google.com/?inventor=Eliott+Teissonniere">
        ...
        <Link legacyBehavior href="https://decrypt.co/16404/what-will-blockchain-look-like-in-2030-the-experts-speak">
          <a>Decrypt</a>
        </Link>
        ,{' '}
        <Link legacyBehavior href="https://cointelegraph.com/news/nodle-outgrows-stellar-begins-to-migrate-to-own-blockchain">
          <a>CoinTelegraph</a>
        </Link>{' '}
        and{' '}
        <Link legacyBehavior href="https://www.coindesk.com/iot-app-nodle-moves-from-stellar-blockchain-to-polkadot">
          <a>CoinDesk</a>
        </Link>
        ; and spoke at multiple high profile events such as the{' '}
        <Link legacyBehavior href="https://hopin.com/events/paris-blockchain-week-summit">
          <a>Paris Blockchain Week</a>
        </Link>
        , the Stanford Blockchain Conference and{' '}
        <Link legacyBehavior href="https://www.blockchain4europe.eu/event/covid-19-tracing-via-blockchain-striking-a-balance-between-privacy-and-public-health/">
          <a>
        ...
        . He is a{' '}
        <Link legacyBehavior href="https://www.xcelerator.berkeley.edu/x-network">
